...
export default function ArticleItemInfo({isShowAvatar, authorAvatar, authorName, pubDate}: Props) {
  return (
    <div className="article-item__info">
      {isShowAvatar && <ArticleItemAvatar authorAvatar={authorAvatar} authorName={authorName}/>}
